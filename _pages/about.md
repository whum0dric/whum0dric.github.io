...
- **第一次内测**
  - **时间**：2024/3/28
  - **对象**：同院学弟学妹共30人
  - **方式**：对初步设计的2个信息图形象（李冰和蔡伦）进行美观程度、创新程度、内涵深度三个方面的打分，以及收集后续建议
...
- **第二次内测**
  ...
  - **方式**：对新推出的多个信息图形象进行打分，评价标准和第一次内测类似
  - **反馈1**-平均得分情况（满分10分）：美观程度9.2，创新程度8.0，内涵深度8.4
  - **反馈2**-相关建议：可以推出其他周边会更好
  - **相应修改**（进行中）：进行信息图、表情包和文创等周边产品的设计。
- **第三次内测**
  - **时间**：2024/4/27
  - **对象**：问卷形式收集了30位上班族问答情况，作答者平均年龄28.7岁
  - **方式**：对新推出的表情包（初稿）和文创进行打分，主要评价美观程度
  - **反馈1**-平均得分情况（满分10分）：表情包美观程度9.3
